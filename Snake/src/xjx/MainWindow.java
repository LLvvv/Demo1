...
//	    setSize(602, 507);
	   ...
	   setLocationRelativeTo(null);
		...
		set_body.setFont(f2);
		//add by jere
		JMenu set_size = new JMenu("窗口设置");
		set_body.setFont(f2);
		JMenu set_speed= new JMenu("设置速度");
		set_speed.setFont(f2);
		final JMenuItem remove_net= new JMenuItem("移除网格");
		...
		headIcon[0].setImage(headIcon[0].getImage().getScaledInstance((int)( (snake.wallW/40)*(2.0/3)),(int)( (snake.wallW/40)*(2.0/3)),Image.SCALE_SMOOTH));//保持图片的清晰
		headIcon[1].setImage(headIcon[1].getImage().getScaledInstance((int)( (snake.wallW/40)*(2.0/3)),(int)( (snake.wallW/40)*(2.0/3)),Image.SCALE_SMOOTH));//保持图片的清晰
		headIcon[2].setImage(headIcon[2].getImage().getScaledInstance((int)( (snake.wallW/40)*(2.0/3)),(int)( (snake.wallW/40)*(2.0/3)),Image.SCALE_SMOOTH));//保持图片的清晰
		headIcon[3].setImage(headIcon[3].getImage().getScaledInstance((int)( (snake.wallW/40)*(2.0/3)),(int)( (snake.wallW/40)*(2.0/3)),Image.SCALE_SMOOTH));//保持图片的清晰
		...
		bodyIcon[0].setImage(bodyIcon[0].getImage().getScaledInstance((int)( (snake.wallW/40)*(2.0/3)),(int)( (snake.wallW/40)*(2.0/3)),Image.SCALE_SMOOTH));//保持图片的清晰
		bodyIcon[1].setImage(bodyIcon[1].getImage().getScaledInstance((int)( (snake.wallW/40)*(2.0/3)),(int)( (snake.wallW/40)*(2.0/3)),Image.SCALE_SMOOTH));//保持图片的清晰
		bodyIcon[2].setImage(bodyIcon[2].getImage().getScaledInstance((int)( (snake.wallW/40)*(2.0/3)),(int)( (snake.wallW/40)*(2.0/3)),Image.SCALE_SMOOTH));//保持图片的清晰
		bodyIcon[3].setImage(bodyIcon[3].getImage().getScaledInstance((int)( (snake.wallW/40)*(2.0/3)),(int)( (snake.wallW/40)*(2.0/3)),Image.SCALE_SMOOTH));//保持图片的清晰
